...
data_text <- data.frame(
    ...
    label = c(
        paste0( # Neutral strong
            ...
            "\n95% CrI: (", rr_from_or(exp(-0.37), 101 / 1096),
        ...
        paste0( # Neutral moderate
            ...
            "\n95% CrI: (", rr_from_or(exp(-0.45), 101 / 1096),
            "; ", rr_from_or(exp(0.20), 101 / 1096), ")\n\n",
            "Pr(Major Benefit) = 44%\n", "Pr(Minor Benefit) = 33%\n",
            "Pr(Minor Harm) = 18%\n", "Pr(Major Harm) = 5%"
        ),
        paste0( # Neutral weak
            ...
            "\n95% CrI: (", rr_from_or(exp(-0.49), 101 / 1096),
        ...
        paste0( # Optimistic strong
            "Median RR = ",
            rr_from_or(exp(-0.15), 101 / 1096),
            "\n95% CrI: (", rr_from_or(exp(-0.31), 101 / 1096),
        ...
        paste0( # Optimistic moderate
            "Median RR = ",
            rr_from_or(exp(-0.15), 101 / 1096),
            "\n95% CrI: (", rr_from_or(exp(-0.38), 101 / 1096),
        ...
        paste0( # Pessimistic strong
            "Median RR = ",
            rr_from_or(exp(0.09), 101 / 1096),
            "\n95% CrI: (", rr_from_or(exp(-0.07), 101 / 1096),
        ...
        paste0( # Pessimistic moderate
            "Median RR = ",
            rr_from_or(exp(0.03), 101 / 1096),
            "\n95% CrI: (", rr_from_or(exp(-0.20), 101 / 1096),
            "; ", rr_from_or(exp(0.26), 101 / 1096), ")\n\n",
            "Pr(Major Benefit) = 6%\n", "Pr(Minor Benefit) = 33%\n",
            "Pr(Minor Harm) = 46%\n", "Pr(Major Harm) = 15%"
        ),
        paste0( # Pessimistic weak
            ...
            rr_from_or(exp(-0.07), 101 / 1096),
            "\n95% CrI: (", rr_from_or(exp(-0.38), 101 / 1096),
            "; ", rr_from_or(exp(0.24), 101 / 1096), ")\n\n",
            "Pr(Major Benefit) = 31%\n", "Pr(Minor Benefit) = 37%\n",
            "Pr(Minor Harm) = 24%\n", "Pr(Major Harm) = 8%"
        )
    )
)
# Plot posterior distributions for death
pdf("figure-05_posteriors-standard-death.pdf", width = 12, height = 12)
data_posteriors |>
